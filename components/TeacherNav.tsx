        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center gap-8">
            <Link href="/teacher" className="flex-shrink-0">
              <span className="text-xl font-bold text-ub-yellow">UB FormFlow (Staff)</span>
            </Link>
            <div className="hidden md:flex gap-2">
              ...
              <Button 
                asChild 
                variant={pathname === '/teacher/history' ? 'default' : 'outline'}
                size="sm"
              >
                <Link href="/teacher/history">History</Link>
              </Button>
