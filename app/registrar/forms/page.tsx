    ...
    <div className="max-w-5xl mx-auto py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button onClick={() => setIsCreating(!isCreating)}>
          {isCreating ? 'Cancel' : <><Plus className="mr-2 h-4 w-4" /> Create New Form</>}
        </Button>
      </div>
      ...
      {isCreating && (
        <Card className="mb-8 border-ub-purple border-2">
          <CardHeader>
            ...
            <CardDescription>Define the workflow and template for a new student form.</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">Upload a PDF or DOCX template for students to download.</p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => setNewForm({...newForm, requires_lecturer_approval: checked as boolean})}
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => setNewForm({...newForm, requires_dean_approval: checked as boolean})}
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => setNewForm({...newForm, requires_registrar_approval: checked as boolean})}
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      onCheckedChange={(checked) => setNewForm({...newForm, requires_accounts_receivable_approval: checked as boolean})}
                    />
                    <Label htmlFor="finance">Accounts Receivable Approval</Label>
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="flex flex-col gap-2">
                <div className="flex gap-2 flex-wrap text-sm text-gray-500">
                  ...
                  {form.requires_lecturer_approval && <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded">Lecturer</span>}
                  {form.requires_dean_approval && <span className="bg-purple-100 text-purple-800 px-2 py-0.5 rounded">Dean</span>}
                  {form.requires_registrar_approval && <span className="bg-yellow-100 text-yellow-800 px-2 py-0.5 rounded">Registrar</span>}
                  {form.requires_accounts_receivable_approval && <span className="bg-green-100 text-green-800 px-2 py-0.5 rounded">Finance</span>}
                </div>
                {form.template_file && (
